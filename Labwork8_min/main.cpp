...
int main() {
    ...
    Result<int> result1(totalScore, "John Doe");
    Result<int> result2(20, "Jane Doe");
    Result<int> combinedResult = result1 + result2;

    cout << "\nTest Result 1: " << result1 << endl;
    cout << "Test Result 2: " << result2 << endl;
    cout << "Combined Result: " << combinedResult << endl;
